...
export default withAuth(
  config({
    ...
    server: {
      port: 3399,
      cors: {
        origin: ["https://dfatest.huseyinonal.com", "http://localhost:3399", "https://acc.digitalforge.be", "https://dfa.huseyinonal.com", "https://web.digitalforge.be", "https://testflw.hocecomv1.com"],
        credentials: true,
      },
