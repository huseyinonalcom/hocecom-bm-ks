...
const participantIdentifierSchemes = {
  ...
  values: [
    ...
    { schemeid: "AD:VAT", iso6523: "9922", country: "AD", "scheme-name": "Andorra VAT number", "initial-release": "1.1.0", state: "active", registrable: true },
    { schemeid: "AL:VAT", iso6523: "9923", country: "AL", "scheme-name": "Albania VAT number", "initial-release": "1.1.0", state: "active", registrable: true },
    {
      schemeid: "BA:VAT",
      iso6523: "9924",
      country: "BA",
    ...
    { schemeid: "BE:VAT", iso6523: "9925", country: "BE", "scheme-name": "Belgium VAT number", "initial-release": "1.1.0", state: "active", registrable: true },
    {
      schemeid: "BG:VAT",
      iso6523: "9926",
      country: "BG",
    ...
    { schemeid: "CY:VAT", iso6523: "9928", country: "CY", "scheme-name": "Cyprus VAT number", "initial-release": "1.1.0", state: "active", registrable: true },
    {
      schemeid: "CZ:VAT",
      iso6523: "9929",
      country: "CZ",
    ...
    { schemeid: "DE:VAT", iso6523: "9930", country: "DE", "scheme-name": "Germany VAT number", "initial-release": "1.1.0", state: "active", registrable: true },
    { schemeid: "EE:VAT", iso6523: "9931", country: "EE", "scheme-name": "Estonia VAT number", "initial-release": "1.1.0", state: "active", registrable: true },
    {
      schemeid: "GB:VAT",
      iso6523: "9932",
      country: "GB",
    ...
    { schemeid: "GR:VAT", iso6523: "9933", country: "GR", "scheme-name": "Greece VAT number", "initial-release": "1.1.0", state: "active", registrable: true },
    { schemeid: "HR:VAT", iso6523: "9934", country: "HR", "scheme-name": "Croatia VAT number", "initial-release": "1.1.0", state: "active", registrable: true },
    { schemeid: "IE:VAT", iso6523: "9935", country: "IE", "scheme-name": "Ireland VAT number", "initial-release": "1.1.0", state: "active", registrable: true },
    {
      schemeid: "LI:VAT",
      iso6523: "9936",
      country: "LI",
    ...
    { schemeid: "LV:VAT", iso6523: "9939", country: "LV", "scheme-name": "Latvia VAT number", "initial-release": "1.1.0", state: "active", registrable: true },
    { schemeid: "MC:VAT", iso6523: "9940", country: "MC", "scheme-name": "Monaco VAT number", "initial-release": "1.1.0", state: "active", registrable: true },
    {
      schemeid: "ME:VAT",
      iso6523: "9941",
      country: "ME",
    ...
    { schemeid: "MT:VAT", iso6523: "9943", country: "MT", "scheme-name": "Malta VAT number", "initial-release": "1.1.0", state: "active", registrable: true },
    {
      schemeid: "NL:VAT",
      iso6523: "9944",
      country: "NL",
    ...
    { schemeid: "PL:VAT", iso6523: "9945", country: "PL", "scheme-name": "Poland VAT number", "initial-release": "1.1.0", state: "active", registrable: true },
    {
      schemeid: "PT:VAT",
      iso6523: "9946",
      country: "PT",
    ...
    { schemeid: "RO:VAT", iso6523: "9947", country: "RO", "scheme-name": "Romania VAT number", "initial-release": "1.1.0", state: "active", registrable: true },
    { schemeid: "RS:VAT", iso6523: "9948", country: "RS", "scheme-name": "Serbia VAT number", "initial-release": "1.1.0", state: "active", registrable: true },
    {
      schemeid: "SI:VAT",
      iso6523: "9949",
      country: "SI",
    ...
    { schemeid: "TR:VAT", iso6523: "9952", country: "TR", "scheme-name": "Turkey VAT number", "initial-release": "1.1.0", state: "active", registrable: true },
    {
      schemeid: "VA:VAT",
      iso6523: "9953",
      country: "VA",
    ...
    { schemeid: "FR:VAT", iso6523: "9957", country: "FR", "scheme-name": "French VAT number", "initial-release": "1.2.1", state: "active", registrable: true },
    {
      schemeid: "DE:LID",
      iso6523: "9958",
      country: "DE",
